      ...
      <a-form-item>
        <a-input
          v-decorator="[
            'facebook',
            {
              initialValue: items.facebook,
              rules: [{ required: true, message: 'Nhập link facebook !' }],
            },
          ]"
      ...
      <a-form-item>
        <a-input
          v-decorator="[
            'instagram',
            {
              initialValue: items.instagram,
              rules: [{ required: true, message: 'Nhập link instagram !' }],
            },
          ]"
        ...
        <a-textarea
          v-decorator="[
            'desc',
            {
              ...
              rules: [{ required: true, message: 'Nhập lời muốn nói !' }],
            },
          ]"
